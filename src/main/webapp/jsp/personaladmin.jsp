<%@page import="com.bru.model.LoginBean"%>
    ...
    pageEncoding="UTF-8"%>
        ...
        <head>
            ...
            <%
            LoginBean bean = null;
            bean = (LoginBean) request.getSession().getAttribute("xxx");
            %>
        </head>

        <body>
            <form name="updatepersonaladmin" id="updatepersonaladmin" action="/updatepersonaladmin" method="get">
                <div class="container" style="margin-top: 1cm; margin-bottom: 11cm">
                            ...
                            <div class="box box-danger">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control" id="password" name="password" disabled="disabled" placeholder="Password" value="<%=bean.getPassword()%>">
                                    </div>
                                    <div class="form-group">
                                        <label>สถานะการทำงาน</label>
                                        <div class="radio">
                                            <label><input type="radio" name="status" id="working" value="1" disabled="disabled" <%if (bean.getStatus().equals( "1")) { out.print("checked ='checked'"); }%>  />ใช้งาน </label>
                                        </div>
                                        <div class="radio">
                                            <label><input type="radio" name="status" id="resign" value="2" disabled="disabled" <%if (bean.getStatus().equals( "2")) { out.print("checked ='checked'"); }%>  />ออก</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="pull-right">
                        ...
                        <button type="submit" class="btn btn-default" onclick="window.location.href='/tableadmin'">ยกเลิก</button>
                    </div>
                </div>
            </form>
        </body>
