<%@page import="com.bru.model.LoginBean"%>
    ...
    pageEncoding="UTF-8"%>
        ...
        <body>
            <form name="updatepersonal" id="updatepersonal" action="/updatepersonal" method="get">
                <div class="container" style="margin-top: 1cm; margin-bottom: 11cm">
                    ...
                    <div class="pull-right">
                        ...
                        <button type="submit" class="btn btn-default" onclick="window.location.href='/table'">ยกเลิก</button>
                    </div>
                </div>
            </form>
        </body>
